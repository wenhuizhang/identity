...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "agntcy.identity.node.v1alpha1.id_service_pb2", _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals["_IDSERVICE"].methods_by_name[
        "Generate"
    ]._serialized_options = b'\222AZ\022LGenerate an Id and its corresponding ResolverMetadata for a specified Issuer*\nGenerateId\202\323\344\223\002\032"\025/v1alpha1/id/generate:\001*'
    _globals["_IDSERVICE"].methods_by_name["Resolve"]._options = None
    _globals["_IDSERVICE"].methods_by_name[
        "Resolve"
    ]._serialized_options = b'\222A@\0223Resolve an Id to its corresponding ResolverMetadata*\tResolveId\202\323\344\223\002\031"\024/v1alpha1/id/resolve:\001*'
