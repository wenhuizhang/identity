...
from agntcy.identity.core.v1alpha1 import (
    issuer_pb2 as agntcy_dot_identity_dot_core_dot_v1alpha1_dot_issuer__pb2,
)
from agntcy.identity.core.v1alpha1 import (
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "agntcy.identity.node.v1alpha1.issuer_service_pb2", _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals["_ISSUERSERVICE"].methods_by_name[
        "Register"
    ]._serialized_options = b'\222AD\0222Register an issuer by providing the issuer details*\016RegisterIssuer\202\323\344\223\002\036"\031/v1alpha1/issuer/register:\001*'
    _globals["_ISSUERSERVICE"].methods_by_name["GetWellKnown"]._options = None
    _globals["_ISSUERSERVICE"].methods_by_name[
        "GetWellKnown"
    ]._serialized_options = b"\222Ae\022OReturns the well-known document for an issuer in Json Web Key Set (JWKS) format*\022GetIssuerWellKnown\202\323\344\223\0026\0224/v1alpha1/issuer/{common_name}/.well-known/jwks.json"
