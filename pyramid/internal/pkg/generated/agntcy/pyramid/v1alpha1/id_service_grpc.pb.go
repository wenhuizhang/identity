...
const (
	IdService_Generate_FullMethodName = "/agntcy.pyramid.v1alpha1.IdService/Generate"
	IdService_Resolve_FullMethodName  = "/agntcy.pyramid.v1alpha1.IdService/Resolve"
)
...
type IdServiceClient interface {
	// Generate an Id
	Generate(ctx context.Context, in *GenerateRequest, opts ...grpc.CallOption) (*AgentPassport, error)
	// Resolve an Id
	Resolve(ctx context.Context, in *ResolveRequest, opts ...grpc.CallOption) (*AgentPassport, error)
}
...
func (c *idServiceClient) Generate(ctx context.Context, in *GenerateRequest, opts ...grpc.CallOption) (*AgentPassport, error) {
...
func (c *idServiceClient) Resolve(ctx context.Context, in *ResolveRequest, opts ...grpc.CallOption) (*AgentPassport, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AgentPassport)
...
type IdServiceServer interface {
	// Generate an Id
	Generate(context.Context, *GenerateRequest) (*AgentPassport, error)
	// Resolve an Id
	Resolve(context.Context, *ResolveRequest) (*AgentPassport, error)
}
...
func (UnimplementedIdServiceServer) Generate(context.Context, *GenerateRequest) (*AgentPassport, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Generate not implemented")
}
func (UnimplementedIdServiceServer) Resolve(context.Context, *ResolveRequest) (*AgentPassport, error) {
...
var IdService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agntcy.pyramid.v1alpha1.IdService",
	...
	Metadata: "agntcy/pyramid/v1alpha1/id_service.proto",
}
