...
const file_agntcy_pyramid_v1alpha1_issuer_service_proto_rawDesc = "" +
	...
	"\x06KeyGen\x12\x16.google.protobuf.Empty\x1a\x1c.agntcy.pyramid.v1alpha1.Jwk\"L\x92A*\x12 Generate a keypair in JWK format*\x06KeyGen\x82\xd3\xe4\x93\x02\x19\x12\x17/v1alpha1/issuer/keygen\x12\xb0\x01\n" +
	"\bRegister\x12(.agntcy.pyramid.v1alpha1.RegisterRequest\x1a).agntcy.pyramid.v1alpha1.RegisterResponse\"O\x92A#\x12\x11Register a issuer*\x0eRegisterIssuer\x82\xd3\xe4\x93\x02#:\x06issuer\"\x19/v1alpha1/issuer/register\x12\xcf\x01\n" +
	"\tWellKnown\x12).agntcy.pyramid.v1alpha1.WellKnownRequest\x1a\x1d.agntcy.pyramid.v1alpha1.Jwks\"x\x92A:\x12-Returns the well-known document for an issuer*\tWellKnown\x82\xd3\xe4\x93\x025\x123/v1alpha1/issuer/{common_name}/.well-known/did.json\x1a\x12\x92A\x0f\n" +
...
var file_agntcy_pyramid_v1alpha1_issuer_service_proto_goTypes = []any{
	...
	(*Jwks)(nil),             // 6: agntcy.pyramid.v1alpha1.Jwks
}
var file_agntcy_pyramid_v1alpha1_issuer_service_proto_depIdxs = []int32{
	...
	6, // 6: agntcy.pyramid.v1alpha1.IssuerService.WellKnown:output_type -> agntcy.pyramid.v1alpha1.Jwks
