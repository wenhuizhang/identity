...
const file_agntcy_pyramid_v1alpha1_did_proto_rawDesc = "" +
	...
	"\x02_g\"8\n" +
	"\x04Jwks\x120\n" +
	"\x04keys\x18\x01 \x03(\v2\x1c.agntcy.pyramid.v1alpha1.JwkR\x04keys\"r\n" +
	"\aService\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tH\x00R\x02id\x88\x01\x01\x12\x17\n" +
	...
	"\x0epublic_key_jwk\x18\x04 \x01(\v2\x1c.agntcy.pyramid.v1alpha1.JwkH\x03R\fpublicKeyJwk\x88\x01\x01B\x05\n" +
	"\x03_idB\a\n" +
	"\x05_typeB\r\n" +
	"\v_controllerB\x11\n" +
...
var file_agntcy_pyramid_v1alpha1_did_proto_goTypes = []any{
	...
	(*Jwks)(nil),               // 2: agntcy.pyramid.v1alpha1.Jwks
...
var file_agntcy_pyramid_v1alpha1_did_proto_depIdxs = []int32{
	...
	1, // 2: agntcy.pyramid.v1alpha1.Jwks.keys:type_name -> agntcy.pyramid.v1alpha1.Jwk
	1, // 3: agntcy.pyramid.v1alpha1.VerificationMethod.public_key_jwk:type_name -> agntcy.pyramid.v1alpha1.Jwk
