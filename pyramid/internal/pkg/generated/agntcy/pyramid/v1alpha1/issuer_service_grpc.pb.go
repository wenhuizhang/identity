...
type IssuerServiceClient interface {
	// Generate a keypair in QJWK format
	KeyGen(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Qjwk, error)
	// Register
	Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error)
	// WellKnown endpoint resolved by did:web:{NODE}:{common_name} method
	WellKnown(ctx context.Context, in *WellKnownRequest, opts ...grpc.CallOption) (*Qjwks, error)
}
...
func (c *issuerServiceClient) KeyGen(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Qjwk, error) {
...
func (c *issuerServiceClient) WellKnown(ctx context.Context, in *WellKnownRequest, opts ...grpc.CallOption) (*Qjwks, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Qjwks)
...
type IssuerServiceServer interface {
	// Generate a keypair in QJWK format
	KeyGen(context.Context, *emptypb.Empty) (*Qjwk, error)
	// Register
	Register(context.Context, *RegisterRequest) (*RegisterResponse, error)
	// WellKnown endpoint resolved by did:web:{NODE}:{common_name} method
	WellKnown(context.Context, *WellKnownRequest) (*Qjwks, error)
}
...
func (UnimplementedIssuerServiceServer) KeyGen(context.Context, *emptypb.Empty) (*Qjwk, error) {
...
func (UnimplementedIssuerServiceServer) WellKnown(context.Context, *WellKnownRequest) (*Qjwks, error) {
