...
func (x *EnveloppedVerifiableCredential) Reset() {
	*x = EnveloppedVerifiableCredential{}
	mi := &file_agntcy_pyramid_v1alpha1_vc_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *EnveloppedVerifiableCredential) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnveloppedVerifiableCredential) ProtoMessage() {}

func (x *EnveloppedVerifiableCredential) ProtoReflect() protoreflect.Message {
	mi := &file_agntcy_pyramid_v1alpha1_vc_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EnveloppedVerifiableCredential.ProtoReflect.Descriptor instead.
func (*EnveloppedVerifiableCredential) Descriptor() ([]byte, []int) {
	return file_agntcy_pyramid_v1alpha1_vc_proto_rawDescGZIP(), []int{2}
}

func (x *EnveloppedVerifiableCredential) GetEnvelopeType() VerifiableCredentialEnvelopeType {
...
func (x *EnveloppedVerifiableCredential) GetValue() string {
...
const file_agntcy_pyramid_v1alpha1_vc_proto_rawDesc = "" +
	...
	"\x05_typeB\x05\n" +
	"\x03_id\"\xbc\x01\n" +
	"\x1eEnveloppedVerifiableCredential\x12c\n" +
...
var file_agntcy_pyramid_v1alpha1_vc_proto_goTypes = []any{
	...
	(*EnveloppedVerifiableCredential)(nil), // 4: agntcy.pyramid.v1alpha1.EnveloppedVerifiableCredential
...
var file_agntcy_pyramid_v1alpha1_vc_proto_depIdxs = []int32{
	...
	1, // 1: agntcy.pyramid.v1alpha1.EnveloppedVerifiableCredential.envelope_type:type_name -> agntcy.pyramid.v1alpha1.VerifiableCredentialEnvelopeType
