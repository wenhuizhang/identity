...
type VerificationResult struct {
	...
	ControlledIdentifierDocument *string `protobuf:"bytes,5,opt,name=controlledIdentifierDocument,proto3,oneof" json:"controlledIdentifierDocument,omitempty"`
...
const file_agntcy_identity_core_v1alpha1_vc_proto_rawDesc = "" +
	...
	"\tmediaType\x18\x03 \x01(\tH\x02R\tmediaType\x88\x01\x01\x12#\n" +
	"\n" +
	"controller\x18\x04 \x01(\tH\x03R\n" +
	"controller\x88\x01\x01\x12G\n" +
	"\x1ccontrolledIdentifierDocument\x18\x05 \x01(\tH\x04R\x1ccontrolledIdentifierDocument\x88\x01\x01\x12D\n" +
	...
	"_mediaTypeB\r\n" +
	"\v_controllerB\x1f\n" +
	"\x1d_controlledIdentifierDocument\"\x06\n" +
	"\x04Time*\x90\x01\n" +
