...
const (
	...
	ErrorReason_ERROR_REASON_VERIFIABLE_CREDENTIAL_IS_REVOKED ErrorReason = 13
)
...
var (
	ErrorReason_name = map[int32]string{
		...
		13: "ERROR_REASON_VERIFIABLE_CREDENTIAL_IS_REVOKED",
	}
	ErrorReason_value = map[string]int32{
		...
		"ERROR_REASON_VERIFIABLE_CREDENTIAL_IS_REVOKED":         13,
	}
)
...
const file_agntcy_identity_core_v1alpha1_errors_proto_rawDesc = "" +
	...
	"\"ERROR_REASON_ID_ALREADY_REGISTERED\x10\f\x121\n" +
	"-ERROR_REASON_VERIFIABLE_CREDENTIAL_IS_REVOKED\x10\rBZZXgithub.com/agntcy/identity/api/server/agntcy/identity/core/v1alpha1;identity_core_sdk_gob\x06proto3"
