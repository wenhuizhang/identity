...
// 	protoc        (unknown)
// source: agntcy/identity/v1alpha1/did.proto
...
func (x *DidDocument) Reset() {
	*x = DidDocument{}
	mi := &file_agntcy_identity_v1alpha1_did_proto_msgTypes[0]
...
func (*DidDocument) Descriptor() ([]byte, []int) {
	return file_agntcy_identity_v1alpha1_did_proto_rawDescGZIP(), []int{0}
}
...
func (x *Jwk) Reset() {
	*x = Jwk{}
	mi := &file_agntcy_identity_v1alpha1_did_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Jwk) Descriptor() ([]byte, []int) {
	return file_agntcy_identity_v1alpha1_did_proto_rawDescGZIP(), []int{1}
}
...
func (x *Jwks) Reset() {
	*x = Jwks{}
	mi := &file_agntcy_identity_v1alpha1_did_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Jwks) Descriptor() ([]byte, []int) {
	return file_agntcy_identity_v1alpha1_did_proto_rawDescGZIP(), []int{2}
}
...
func (x *Service) Reset() {
	*x = Service{}
	mi := &file_agntcy_identity_v1alpha1_did_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Service) Descriptor() ([]byte, []int) {
	return file_agntcy_identity_v1alpha1_did_proto_rawDescGZIP(), []int{3}
}
...
func (x *VerificationMethod) Reset() {
	*x = VerificationMethod{}
	mi := &file_agntcy_identity_v1alpha1_did_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VerificationMethod) Descriptor() ([]byte, []int) {
	return file_agntcy_identity_v1alpha1_did_proto_rawDescGZIP(), []int{4}
}
...
var File_agntcy_identity_v1alpha1_did_proto protoreflect.FileDescriptor
...
var (
	...
	file_agntcy_identity_v1alpha1_did_proto_rawDescData []byte
)

func file_agntcy_identity_v1alpha1_did_proto_rawDescGZIP() []byte {
	file_agntcy_identity_v1alpha1_did_proto_rawDescOnce.Do(func() {
		file_agntcy_identity_v1alpha1_did_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_agntcy_identity_v1alpha1_did_proto_rawDesc), len(file_agntcy_identity_v1alpha1_did_proto_rawDesc)))
	})
	return file_agntcy_identity_v1alpha1_did_proto_rawDescData
}

var file_agntcy_identity_v1alpha1_did_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_agntcy_identity_v1alpha1_did_proto_goTypes = []any{
	(*DidDocument)(nil),        // 0: agntcy.identity.v1alpha1.DidDocument
	(*Jwk)(nil),                // 1: agntcy.identity.v1alpha1.Jwk
	(*Jwks)(nil),               // 2: agntcy.identity.v1alpha1.Jwks
	(*Service)(nil),            // 3: agntcy.identity.v1alpha1.Service
	(*VerificationMethod)(nil), // 4: agntcy.identity.v1alpha1.VerificationMethod
}
var file_agntcy_identity_v1alpha1_did_proto_depIdxs = []int32{
	4, // 0: agntcy.identity.v1alpha1.DidDocument.verification_method:type_name -> agntcy.identity.v1alpha1.VerificationMethod
	3, // 1: agntcy.identity.v1alpha1.DidDocument.service:type_name -> agntcy.identity.v1alpha1.Service
	1, // 2: agntcy.identity.v1alpha1.Jwks.keys:type_name -> agntcy.identity.v1alpha1.Jwk
	1, // 3: agntcy.identity.v1alpha1.VerificationMethod.public_key_jwk:type_name -> agntcy.identity.v1alpha1.Jwk
...
func init() { file_agntcy_identity_v1alpha1_did_proto_init() }
func file_agntcy_identity_v1alpha1_did_proto_init() {
	if File_agntcy_identity_v1alpha1_did_proto != nil {
		return
	}
	file_agntcy_identity_v1alpha1_did_proto_msgTypes[0].OneofWrappers = []any{}
	file_agntcy_identity_v1alpha1_did_proto_msgTypes[1].OneofWrappers = []any{}
	file_agntcy_identity_v1alpha1_did_proto_msgTypes[3].OneofWrappers = []any{}
	file_agntcy_identity_v1alpha1_did_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_agntcy_identity_v1alpha1_did_proto_rawDesc), len(file_agntcy_identity_v1alpha1_did_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_agntcy_identity_v1alpha1_did_proto_goTypes,
		DependencyIndexes: file_agntcy_identity_v1alpha1_did_proto_depIdxs,
		MessageInfos:      file_agntcy_identity_v1alpha1_did_proto_msgTypes,
	}.Build()
	File_agntcy_identity_v1alpha1_did_proto = out.File
	file_agntcy_identity_v1alpha1_did_proto_goTypes = nil
	file_agntcy_identity_v1alpha1_did_proto_depIdxs = nil
}
