...
// 	protoc        (unknown)
// source: agntcy/identity/v1alpha1/id.proto
...
func (x *IdDocument) Reset() {
	*x = IdDocument{}
	mi := &file_agntcy_identity_v1alpha1_id_proto_msgTypes[0]
...
func (*IdDocument) Descriptor() ([]byte, []int) {
	return file_agntcy_identity_v1alpha1_id_proto_rawDescGZIP(), []int{0}
}
...
func (x *Jwk) Reset() {
	*x = Jwk{}
	mi := &file_agntcy_identity_v1alpha1_id_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Jwk) Descriptor() ([]byte, []int) {
	return file_agntcy_identity_v1alpha1_id_proto_rawDescGZIP(), []int{1}
}
...
func (x *Jwks) Reset() {
	*x = Jwks{}
	mi := &file_agntcy_identity_v1alpha1_id_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Jwks) Descriptor() ([]byte, []int) {
	return file_agntcy_identity_v1alpha1_id_proto_rawDescGZIP(), []int{2}
}
...
func (x *VerificationMethod) Reset() {
	*x = VerificationMethod{}
	mi := &file_agntcy_identity_v1alpha1_id_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VerificationMethod) Descriptor() ([]byte, []int) {
	return file_agntcy_identity_v1alpha1_id_proto_rawDescGZIP(), []int{3}
}
...
var File_agntcy_identity_v1alpha1_id_proto protoreflect.FileDescriptor

const file_agntcy_identity_v1alpha1_id_proto_rawDesc = "" +
	"\n" +
	"!agntcy/identity/v1alpha1/id.proto\x12\x18agntcy.identity.v1alpha1\"\xa9\x01\n" +
	"\n" +
	"IdDocument\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tH\x00R\x02id\x88\x01\x01\x12\x17\n" +
	"\x04node\x18\x02 \x01(\tH\x01R\x04node\x88\x01\x01\x12]\n" +
	"\x13verification_method\x18\x03 \x03(\v2,.agntcy.identity.v1alpha1.VerificationMethodR\x12verificationMethodB\x05\n" +
	"\x03_idB\a\n" +
	"\x05_node\"\xb5\x03\n" +
	"\x03Jwk\x12\x15\n" +
	...
	"\x03_qi\"9\n" +
	"\x04Jwks\x121\n" +
	"\x04keys\x18\x01 \x03(\v2\x1d.agntcy.identity.v1alpha1.JwkR\x04keys\"\x8d\x01\n" +
	"\x12VerificationMethod\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tH\x00R\x02id\x88\x01\x01\x12H\n" +
	"\x0epublic_key_jwk\x18\x02 \x01(\v2\x1d.agntcy.identity.v1alpha1.JwkH\x01R\fpublicKeyJwk\x88\x01\x01B\x05\n" +
	"\x03_idB\x11\n" +
...
var (
	file_agntcy_identity_v1alpha1_id_proto_rawDescOnce sync.Once
	file_agntcy_identity_v1alpha1_id_proto_rawDescData []byte
)

func file_agntcy_identity_v1alpha1_id_proto_rawDescGZIP() []byte {
	file_agntcy_identity_v1alpha1_id_proto_rawDescOnce.Do(func() {
		file_agntcy_identity_v1alpha1_id_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_agntcy_identity_v1alpha1_id_proto_rawDesc), len(file_agntcy_identity_v1alpha1_id_proto_rawDesc)))
	})
	return file_agntcy_identity_v1alpha1_id_proto_rawDescData
}

var file_agntcy_identity_v1alpha1_id_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_agntcy_identity_v1alpha1_id_proto_goTypes = []any{
	(*IdDocument)(nil),         // 0: agntcy.identity.v1alpha1.IdDocument
	(*Jwk)(nil),                // 1: agntcy.identity.v1alpha1.Jwk
	(*Jwks)(nil),               // 2: agntcy.identity.v1alpha1.Jwks
	(*VerificationMethod)(nil), // 3: agntcy.identity.v1alpha1.VerificationMethod
}
var file_agntcy_identity_v1alpha1_id_proto_depIdxs = []int32{
	3, // 0: agntcy.identity.v1alpha1.IdDocument.verification_method:type_name -> agntcy.identity.v1alpha1.VerificationMethod
	1, // 1: agntcy.identity.v1alpha1.Jwks.keys:type_name -> agntcy.identity.v1alpha1.Jwk
	1, // 2: agntcy.identity.v1alpha1.VerificationMethod.public_key_jwk:type_name -> agntcy.identity.v1alpha1.Jwk
...
func init() { file_agntcy_identity_v1alpha1_id_proto_init() }
func file_agntcy_identity_v1alpha1_id_proto_init() {
	if File_agntcy_identity_v1alpha1_id_proto != nil {
		return
	}
	file_agntcy_identity_v1alpha1_id_proto_msgTypes[0].OneofWrappers = []any{}
	file_agntcy_identity_v1alpha1_id_proto_msgTypes[1].OneofWrappers = []any{}
	file_agntcy_identity_v1alpha1_id_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_agntcy_identity_v1alpha1_id_proto_rawDesc), len(file_agntcy_identity_v1alpha1_id_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_agntcy_identity_v1alpha1_id_proto_goTypes,
		DependencyIndexes: file_agntcy_identity_v1alpha1_id_proto_depIdxs,
		MessageInfos:      file_agntcy_identity_v1alpha1_id_proto_msgTypes,
	}.Build()
	File_agntcy_identity_v1alpha1_id_proto = out.File
	file_agntcy_identity_v1alpha1_id_proto_goTypes = nil
	file_agntcy_identity_v1alpha1_id_proto_depIdxs = nil
}
