...
func RegisterIssuerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IssuerServiceServer) error {
	...
	mux.Handle(http.MethodGet, pattern_IssuerService_WellKnown_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/agntcy.identity.node.v1alpha1.IssuerService/WellKnown", runtime.WithHTTPPathPattern("/v1alpha1/issuer/{common_name}/.well-known/jwks.json"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterIssuerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IssuerServiceClient) error {
	...
	mux.Handle(http.MethodGet, pattern_IssuerService_WellKnown_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/agntcy.identity.node.v1alpha1.IssuerService/WellKnown", runtime.WithHTTPPathPattern("/v1alpha1/issuer/{common_name}/.well-known/jwks.json"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
