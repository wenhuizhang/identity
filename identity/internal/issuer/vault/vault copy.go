...
func ConnectVault() (*internalIssuerTypes.Vault, error) {
...
func ListVaultIds() ([]string, error) {
...
func GetVault(vaultId string) (*internalIssuerTypes.Vault, error) {
...
func ForgetVault(vaultId string) error {
